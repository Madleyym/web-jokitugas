...
export default function Card({ image, title, description }: { image: string, title: string, description: string }) {
    return (
        <div
            className="mb-4 flex flex-col justify-between gap-2 max-w-72 p-4 border border-fg rounded-xl transform scale-100 hover:scale-105 transition-transform duration-300">
